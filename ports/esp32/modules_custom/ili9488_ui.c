/*
 * ili9488_ui.c - High-performance UI widget library for ILI9488 display
 * 
...
static mp_obj_t ui_draw_button3d(size_t n_args, const mp_obj_t *args) {
    ...
    // Auto-update the button region
    update_region(x, y, width, height);
...
static mp_obj_t ui_draw_radiobutton(size_t n_args, const mp_obj_t *args) {
    ...
    // Auto-update (bounding box around circle)
    update_region(center_x - radius - 1, center_y - radius - 1, 
...
static mp_obj_t ui_draw_dialog_frame(size_t n_args, const mp_obj_t *args) {
    ...
    // Auto-update (include shadow)
    update_region(x, y, width + shadow_offset, height + shadow_offset);
